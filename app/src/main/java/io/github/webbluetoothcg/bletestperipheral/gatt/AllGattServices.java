package io.github.webbluetoothcg.bletestperipheral.gatt;
...
public class AllGattServices {
    ...
    public static String[] getAllServices() {
        String[] services = new String[attributes.size()];
        return attributes.values().toArray(services);
    }

    public static UUID lookup(String serviceName) {
        for (String key : attributes.keySet()) {
            if (attributes.get(key).equals(serviceName))
